      ...
      <div>
            ...
            <div className="row">
              <div className="col-lg-2">
                <div className="header__logo">
                  <a href="./">
                    <img src="Images/digiweb.png" alt="" />
                  </a>
                </div>
              </div>
              <div className="col-lg-10">
                <nav className="header__menu">
                  <ul>
                    ...
                    <li>
                      <a className="Header" href="./HomeCommande">
                        Message
                      </a>
                    </li>
                    <li>
                      <a className="Header" href="./Profile">
                        Profile
                      </a>
                    </li>
                    {this.state.isLoged ? (
                      <span>
                        <li>
                          <a className="Header" href="./commandesParStatut">
                            Mes commandes
                          </a>
                        </li>
        ...
        <div className="humberger__menu__wrapper">
          ...
          <nav className="humberger__menu__nav mobile-menu">
            <ul>
              <li className="active">
                <a className="Header" href="./ToutesLesAnnonces">
                  Nos Espèces{" "}
                </a>
              </li>
              <li>
